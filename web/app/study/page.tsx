...
import { Brain, CalendarCheck, ChalkboardTeacher, Cards, Graph, Sparkle, Timer } from "@phosphor-icons/react/dist/ssr";
...
const KINDS = [
  ...
  { kind: "graph", label: "Graph", blurb: "The Pot's ideas, drawn and connected.", icon: <Graph weight="fill" /> },
