 ...
 * blob, one side drop, one dot. `opening` is the color that shows through
 * the pot mouth and the m knockout: pass the surface it sits on.
 */
export function PotMark({
  ...
  return (
    ...
    >
      ...
      />
      {/* Mouth opening. */}
      <ellipse cx="120" cy="104" rx="80" ry="12" fill={opening} />
      ...
      {/* The lowercase m, knocked out of the body. */}
      <path
        d="M82 204v-46c0-15 9-23 19-23s17 8 17 21v48M118 156c0-13 7-21 17-21s19 8 19 23v46"
        fill="none"
        stroke={opening}
        strokeWidth="22"
        strokeLinecap="round"
...
export function PotHeroArt({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 680 850" className={className} aria-hidden>
      <defs>
      ...
      />
      {/* Mouth opening. */}
      <ellipse cx="340" cy="575" rx="210" ry="26" fill="var(--paper)" />
      ...
      {/* The m knockout. */}
      <path
        d="M234 812v-118c0-34 22-54 47-54s43 20 43 50v126M324 690c0-30 18-50 43-50s47 20 47 54v118"
        fill="none"
        stroke="var(--paper)"
        strokeWidth="50"
        strokeLinecap="round"
