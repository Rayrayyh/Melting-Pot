-- Dev seed: one realistic Pot with members, sections, shared notes, an
-- accepted correction in history, a pending proposal, and a draft.
-- Idempotent: wipes and recreates its own data only. NEVER run in production
-- (decision 005: production ships clean).
