-- The owner added a fifth rule to the signup checklist: one symbol. A symbol
-- here is anything that is not a letter, digit or whitespace, which matches
-- the client helper in web/lib/auth/password-rules.ts character for
-- character. Everything below the weak_password block is the live function
-- body unchanged.
